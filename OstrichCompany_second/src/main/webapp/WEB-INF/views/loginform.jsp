...
<head>
<meta charset="UTF-8">
<title>Ostrich Company</title>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/scripts/jqueryUI/jquery-ui.min.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/scripts/jqGrid/css/ui.jqgrid.css" />
<link rel="stylesheet" type="text/css"
...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/scripts/jqGrid/plugins/ui.multiselect.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/loginform_util.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/loginform_main.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/loginform_modified.css" />

<script
	src="${pageContext.request.contextPath}/scripts/jquery/jquery-3.3.1.min.js"></script>
<script
	src="${pageContext.request.contextPath}/scripts/jqueryUI/jquery-ui.min.js"></script>
<script
	src="${pageContext.request.contextPath}/scripts/jqGrid/js/jquery.jqGrid.min.js"></script>
<script
	src="${pageContext.request.contextPath}/scripts/jqGrid/js/i18n/grid.locale-kr.js"></script>
<style>
...
body {
	background-image:
		url("${pageContext.request.contextPath}/scripts/images/img2.jpg");
...
<body>
	...
	<div id="insertSource">
		<h1>
			<font color="grey">Ostrich Company(2차)</font>
		</h1>
		<br>
		<form method="post"
			action="${pageContext.request.contextPath}/login.do?method=LogInCheck">
			<input type="text" placeholder="회사코드" name="companyCode"
				id="companyCode"> &nbsp; <input type="button" value="+"
				id="companyCodeSearchButton"><br> <input type="text"
				placeholder="사업장코드" name="workplaceCode" id="workplaceCode">
			&nbsp; <input type="button" value="+" id="workplaceCodeSearchButton"><br>
			<input type="text" placeholder="사원ID" name="userId"><br>
			<input type="password" placeholder="비밀번호" name="userPassWord"><br>
			<input id="ckb1" type="checkbox" name="rmb"> <label
				for="ckb1"><font color="white">ID기억하기</font> </label> <input
				type="submit" value="로그인" id="logInButton" style="margin-left: 85px">
