...
import com.project.OstrichCompany.logistics.production.to.MrpGatheringTO;
import com.project.OstrichCompany.logistics.production.to.MrpTO;

public class MrpController extends MultiActionController {

	// serviceFacade 참조변수 선언
	private static ProductionServiceFacade productionSF;

	private ModelAndView modelAndView;
	private ModelMap modelMap = new ModelMap();

	public void setProductionSF(ProductionServiceFacade productionSF) {
		MrpController.productionSF = productionSF;
	}
	...
	public ModelAndView openMrp(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<String> mpsNoArr = gson.fromJson(mpsNoListStr, new TypeToken<ArrayList<String>>() {
		}.getType());
	...
	public ModelAndView registerMrp(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<MrpTO> newMrpList = gson.fromJson(batchList, new TypeToken<ArrayList<MrpTO>>() {
		}.getType());
	...
	public ModelAndView getMrpGatheringList(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<String> mrpNoArr = gson.fromJson(mrpNoList, new TypeToken<ArrayList<String>>() {
		}.getType());
	...
	public ModelAndView registerMrpGathering(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<MrpGatheringTO> newMrpGatheringList = gson.fromJson(batchList,
				new TypeToken<ArrayList<MrpGatheringTO>>() {
				}.getType());

		HashMap<String, String> mrpNoAndItemCodeMap = gson.fromJson(mrpNoAndItemCodeList,
