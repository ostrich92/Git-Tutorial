...
public class ContractDAOImpl implements ContractDAO {
	...
	public ArrayList<ContractInfoTO> selectContractListByDate(String startDate, String endDate) {//수주조회에서 기간검색쿼리
	...
	public ArrayList<ContractInfoTO> selectContractListByCustomer(String customerCode) {//수주조회에서 거래처검색쿼리
