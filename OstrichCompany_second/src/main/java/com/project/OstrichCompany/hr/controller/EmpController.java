package com.project.OstrichCompany.hr.controller;
...
import com.project.OstrichCompany.hr.serviceFacade.HrServiceFacade;
...
public class EmpController extends MultiActionController {
	...
	public ModelAndView searchEmpInfo(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			EmpInfoTO empInfoBean = hrSF.getEmpInfo(companyCode, empCode);

			modelMap.put("empInfo", empInfoBean);
			modelMap.put("errorCode", 1);
			modelMap.put("errorMsg", "성공");
