...
import com.project.OstrichCompany.basicInfo.serviceFacade.CooperatorServiceFacade;
...
public class CustomerController extends MultiActionController {
	...
	public ModelAndView searchCustomerList(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			ArrayList<CustomerTO> customerList = cooperatorSF.getCustomerList(searchCondition, companyCode,
					workplaceCode);
