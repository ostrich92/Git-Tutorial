...
public class DepartmentDAOImpl implements DepartmentDAO {
	...
	public void insertDepartment(DepartmentTO bean) {
		...
		try {
			...
			/*
			 * 
			 * Insert into DEPARTMENT ( WORKPLACE_CODE , DEPT_CODE , DEPT_NAME ,
			 * WORKPLACE_NAME , COMPANY_CODE , COMPANY_NAME , DEPT_START_DATE ,
			 * DEPT_END_DATE ) values ( ? , ? , ? , ? , ? , ? , ? )
			 * 
			 */
	...
	public void updateDepartment(DepartmentTO bean) {
		...
		try {
			...
			/*
			 * 
			 * UPDATE DEPARTMENT SET DEPT_NAME = ? , WORKPLACE_NAME = ? , COMPANY_CODE = ? ,
			 * DEPT_START_DATE = ? , DEPT_END_DATE = ? WHERE WORKPLACE_CODE = ? AND
			 * DEPT_CODE = ?
			 * 
			 */
	...
	public void deleteDepartment(DepartmentTO bean) {
		...
		try {
			...
			/*
			 * DELETE FROM DEPARTMENT WHERE WORKPLACE_CODE = ? AND DEPT_CODE = ?
			 */
